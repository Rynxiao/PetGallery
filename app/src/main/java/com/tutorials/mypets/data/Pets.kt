...
val pets = listOf(
    Pet(
        ...
        samples = listOf(
            Sample(name = "Theresia", imageRes = R.drawable.img_akita_1, brief = "I'm cute!", sex = Sex.Female),
            Sample(name = "Haight", imageRes = R.drawable.img_akita_2, brief = "I'm cute!", age = 3),
            Sample(name = "Idonea", imageRes = R.drawable.img_akita_3, brief = "I'm cute!", weight = 2.7f),
        )
    ),
    Pet(
        id = UUID.randomUUID().toString(),
        ...
        samples = listOf(
            Sample(name = "Calyse", imageRes = R.drawable.img_alaskan_1),
            Sample(name = "Heacock", imageRes = R.drawable.img_alaskan_2, sex = Sex.Female),
            Sample(name = "Nystrom", imageRes = R.drawable.img_alaskan_3, weight = 5.4f),
            Sample(name = "Boddie", imageRes = R.drawable.img_alaskan_4, age = 1, sex = Sex.Female),
        )
    ),
    Pet(
        id = UUID.randomUUID().toString(),
        ...
        samples = listOf(
            Sample(name = "Glanville", imageRes = R.drawable.img_ashort_1),
            Sample(name = "Trichel", imageRes = R.drawable.img_ashort_2, age = 1, sex = Sex.Female),
            Sample(name = "Deike", imageRes = R.drawable.img_ashort_3, weight = 4.3f, age = 4),
            Sample(name = "Henle", imageRes = R.drawable.img_ashort_4, age = 3),
        )
    ),
    Pet(
        id = UUID.randomUUID().toString(),
        ...
        samples = listOf(
            Sample(name = "Dorough", imageRes = R.drawable.img_bshort_1, weight = 5.6f),
            Sample(name = "Mcquade", imageRes = R.drawable.img_bshort_2, weight = 4.3f, age = 4),
            Sample(name = "Dunville", imageRes = R.drawable.img_bshort_3, sex = Sex.Male),
            Sample(name = "Wheatley", imageRes = R.drawable.img_bshort_4, age = 3),
        )
    ),
    Pet(
        id = UUID.randomUUID().toString(),
        ...
        samples = listOf(
            Sample(name = "Hicklin", imageRes = R.drawable.img_ss_1, weight = 2.3f, age = 4),
            Sample(name = "Thurgood", imageRes = R.drawable.img_ss_2, weight = 1.2f, age = 1),
        )
    ),
    Pet(
        id = UUID.randomUUID().toString(),
        ...
        samples = listOf(
            Sample(name = "Ahu", imageRes = R.drawable.img_chinese_1, weight = 4.3f, age = 4, sex = Sex.Female),
            Sample(name = "Nima", imageRes = R.drawable.img_chinese_2, weight = 3.3f, age = 5),
            Sample(name = "Wendeline", imageRes = R.drawable.img_chinese_3, weight = 2.9f, age = 3, sex = Sex.Female),
        )
    ),
    Pet(
        id = UUID.randomUUID().toString(),
        ...
        samples = listOf(
            Sample(name = "Erlandson", imageRes = R.drawable.img_corgi_1, weight = 1.3f, age = 4, sex = Sex.Female),
            Sample(name = "Ector", imageRes = R.drawable.img_corgi_2, weight = 2.4f, age = 3),
            Sample(name = "Moodey", imageRes = R.drawable.img_corgi_3, weight = 2.7f, age = 6),
            Sample(name = "Diehl", imageRes = R.drawable.img_corgi_4, weight = 4.0f, age = 4, sex = Sex.Female),
        )
    ),
    Pet(
        id = UUID.randomUUID().toString(),
        ...
        samples = listOf(
            Sample(name = "Benish", imageRes = R.drawable.img_golden_1, weight = 1.3f, age = 4, sex = Sex.Female),
            Sample(name = "Jermy", imageRes = R.drawable.img_golden_2, weight = 2.4f, age = 3),
            Sample(name = "Rhilynn", imageRes = R.drawable.img_golden_3),
            Sample(name = "Macklem", imageRes = R.drawable.img_golden_4, weight = 2.7f, age = 6),
        )
    ),
    Pet(
        id = UUID.randomUUID().toString(),
        ...
        samples = listOf(
            Sample(name = "Andreou", imageRes = R.drawable.img_husky_1, weight = 2.4f, age = 3),
            Sample(name = "Shelley", imageRes = R.drawable.img_husky_2, weight = 2.7f, age = 6),
            Sample(name = "Mischa", imageRes = R.drawable.img_husky_3, sex = Sex.Female),
            Sample(name = "Harwell", imageRes = R.drawable.img_husky_4, weight = 4.3f, age = 4),
        )
    ),
    Pet(
        id = UUID.randomUUID().toString(),
        ...
        samples = listOf(
            Sample(name = "Lynnzie", imageRes = R.drawable.img_samoyed_1, weight = 1.3f, age = 4, sex = Sex.Female),
            Sample(name = "Broderson", imageRes = R.drawable.img_samoyed_2),
            Sample(name = "Bovey", imageRes = R.drawable.img_samoyed_3, weight = 2.7f, age = 6),
            Sample(name = "Dole", imageRes = R.drawable.img_samoyed_4, weight = 2.7f, age = 4),
        )
    ),
    Pet(
        id = UUID.randomUUID().toString(),
        ...
        samples = listOf(
            Sample(name = "Stanczyk", imageRes = R.drawable.img_shibainu_1, weight = 4.2f, age = 3),
            Sample(name = "Lann", imageRes = R.drawable.img_shibainu_2, weight = 1.7f, age = 4, sex = Sex.Female),
        )
    ),
    Pet(
        id = UUID.randomUUID().toString(),
        ...
        samples = listOf(
            Sample(name = "Attoe", imageRes = R.drawable.img_poodle_1, age = 4),
            Sample(name = "Liebowitz", imageRes = R.drawable.img_poodle_2, weight = 4.2f, age = 3),
            Sample(name = "Hursh", imageRes = R.drawable.img_poodle_3),
        )
    ),
    Pet(
        id = UUID.randomUUID().toString(),
        ...
        samples = listOf(
            Sample(name = "Anderman", imageRes = R.drawable.img_gs_1, weight = 4.7f, age = 3),
            Sample(name = "Greely", imageRes = R.drawable.img_gs_2, weight = 2.2f, age = 5, sex = Sex.Female),
            Sample(name = "Kaho", imageRes = R.drawable.img_gs_3, weight = 3.2f, age = 4),
        )
    )
)
